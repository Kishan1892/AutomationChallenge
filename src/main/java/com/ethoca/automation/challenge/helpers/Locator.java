...
public class Locator {
	...
	public By productPrintedChiffonDress = By
			.xpath("//div[@class='product-image-container']/a[@title='Printed Chiffon Dress']");

	public By productPrintedChiffonDressQuickView = By
			.xpath("//div[a[@title='Printed Chiffon Dress']]/a/span[contains(text(),'Quick view')]");
	...
	public By productPrintedChiffonDressNameText = By
			.xpath("//p[@class='product-name']/a[contains(text(),'Printed Chiffon Dress')]");

	public By productPrintedChiffonDressSizeColorText = By
			.xpath("//td[p[@class='product-name']/a[contains(text(),'Printed Chiffon Dress')]]/small/a");

	public By productPrintedChiffonDressQuantity = By.xpath(
			"//tr[td[p[@class='product-name']/a[contains(text(),'Printed Chiffon Dress')]]]/td[@class='cart_quantity text-center']");

	public By productPrintedChiffonDressQuantityOnePrice = By.xpath(
			"//tr[td[p[@class='product-name']/a[contains(text(),'Printed Chiffon Dress')]]]//td[@class='cart_total']");
